...
# !!! Main.UserApp is configured as an alias for Main.Ai4ELab and you might encounter it in some tests
using Main.Ai4ELab, Test, TestSetExtensions, Logging

Logging.global_logger(NullLogger())

@testset ExtendedTestSet "Ai4ELab tests" begin
  @includetests ARGS
end
